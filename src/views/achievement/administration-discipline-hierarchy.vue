		...
		<div class="ui-table-wrap clearfix">
			...
			<div class="ui-table-main">
				<el-table :data="list" border style="width: 100%" :max-height="screenHeight" :default-sort = "{prop: 'chineseScoringRate', order: 'descending'}">
					...
					<el-table-column prop='name1' label='教师' width="120"></el-table-column>
					...
					<el-table-column label='优良率' header-align='center'>
						<el-table-column prop="number4" label="优良数" width="100"></el-table-column>
						<el-table-column prop="float5" label="优良率" width="100"></el-table-column>
						<el-table-column prop="number2" label="名次" width="100"></el-table-column>
						<el-table-column prop="number4" label="进步值" width="100"></el-table-column>
					</el-table-column>
					<el-table-column label='及格率' header-align='center'>
						<el-table-column prop="float2" label="及格数" width="100"></el-table-column>
					...
					<el-table-column label='低分率' header-align='center'>
						<el-table-column prop="float6" label="低分数" width="100"></el-table-column>
