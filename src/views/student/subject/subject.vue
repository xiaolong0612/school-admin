<template>
  <div>
    <div class="ui-search-wrap" id="ui-search-wrap">
       ...
       <router-link to="/student-special/index">专题</router-link>
    </div>
    <div>
    <el-row :gutter="15">
      <el-col :span="20">
      ...
      <div class="fr ui-right-wrap text-center">
        
      </div>
      <div class="fl ui-left-wrap text-center">
...
<script>
  ...
  export default {
    data() {
      return {
        name: '',
        classList: ['语文', '数学', '英语', '物理', '地理', '化学', '生物', '历史', '四品'],
        specialList: [
          {name: '语言积累', number: '0%'},
          {name: '语言运用', number: '0%'},
          {name: '非连阅读', number: '5%'},
