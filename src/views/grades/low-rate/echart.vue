<template>
  <div>
    <div class="ui-search-wrap" id="ui-search-wrap">
      <el-form :inline="true">
        ...
        <el-form-item class="fr">
          <router-link to="/grades/low-rate/table" >
    ...
    <div class="echarts-wrap ui-echart-wrap" style="padding-right: 3%;">
      <chart height='calc(100vh - 265px)' width='100%' :setChartOption="chart.setOption" :clickChart="true" clickPath="/grades/low-rate/class" :xParmas="x_id"></chart>
    </div>
  </div>
</template>
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        getSchoolLowGradeRateByPeriodAndSubjectAndGradeEchart({paperId:this.listQuery.paperId}).then(res => {
